...
import aspire.basis.config.JdbcConfig;
import aspire.framework.db.jooq.log.JooqLoggerListener;
import aspire.framework.jackson.AspireJsonFilterProvider;
import aspire.framework.utils.Json2Utils;
...
public class BasisPortalApplication {

    private static final Logger LOG = LoggerFactory.getLogger(BasisPortalApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(BasisPortalApplication.class, args);
    }
